...
namespace Adfnet.Setup.Installations
{
    public static class ParameterInstallation
    {
        ...
        private static readonly List<Tuple<string, string, string>> Parameters = new List<Tuple<string, string, string>>
        {
            ...
            new Tuple<string, string, string>("ApplicationParameters","SendMailAfterUpdateUserInformation","true"),
            new Tuple<string, string, string>("ApplicationParameters","SendMailAfterUpdateUserPassword","true"),
            new Tuple<string, string, string>("ApplicationParameters","SendMailAfterAddUser","true"),
